...
>
> `index.html` simply visualizes human heat envelope. note on graphics - it is more optimal to use radial gradient with alpha-blending (blur is useless for vector graphics), akin to how `bird2.html` does.
