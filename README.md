...
>> btc fund address: bc1qekvmkczge3hxrvwdf2lj3yyvgjnparn3fdf9lg acts as a SANITY CHECK - **if there is no activity there IRL (blockchain explorers don't show), user does not interact with reality then, they imagine (or AI Game Master imagines) the increase.**
>> 
